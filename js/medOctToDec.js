...
function generateLevel(){
    ...
    start = decimalToOctString(correct);
}
...
function addElement(){
    ...
    loseBtn2.classList.add('btn-warning');
    ...
    container.innerHTML += `<img src="https://i.kym-cdn.com/entries/icons/mobile/000/018/012/this_is_fine.jpg" alt="This is Fine" width="400">`;

    container.addEventListener('click', (event) =>{
        if(event.target.matches('.winBtn')){
            document.location = 'oct4.html';
        }
        else{
